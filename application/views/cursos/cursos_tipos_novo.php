                ...
                <?php } 
                        ...
                        if($result == true){
                            ...
                            echo "<div class=\"alert alert-success\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>
                                    Tipo de curso cadastrado com sucesso.
                                  </div>";
                        }
                        
                ?>
                
                <form method="POST" action="<?php echo base_url()?>cursos/tipos_novo">
                    <a href="<?php echo base_url()?>cursos/tipos"><button class="btn" type="button">Sair</button></a>
