        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <?php if (form_error('nome') || form_error('status') || form_error('link')){?>
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>videos/editar">
                    <a href="<?php echo base_url()?>videos"><button class="btn" type="button">Sair</button></a>
                    ...
                    <div class="input-prepend">
                        ...
                        <input name="nome" class="input-block-level" type="text" value="<?php echo $video['0']->nome?>">
                    </div><br/>

                    <div class="input-prepend">
                        <span class="add-on" style="width: 100px; height: 20px; text-align: right; font-weight: bold;">Link</span>
                        <input name="link" class="input-block-level" type="text" value="<?php echo $video['0']->link?>">
                    </div><br/>
                    ...
                    <div class="input-prepend">
                        ...
                        <select name="status" class="span3" style="width: auto;">
                            <option></option>
                            <option value="1" <?php if($video['0']->status == 1) echo "selected";  ?> >Ativo</option>
                            <option value="0" <?php if($video['0']->status == 0) echo "selected";  ?> >Desativado</option>
                        </select>
                    </div>
                </form>
