        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <form enctype="multipart/form-data" method="POST" action="<?php echo base_url()?>cursos/editar/<?php echo $curso['0']->id?>">
                    ...
                    <div class="input-prepend">
                        <span class="add-on" style="width: 100px; text-align: right; font-weight: bold;">Inscrições</span>
                        <select name="form_inscricao" class="span3" style="width: auto;">
                            <option></option>
                            <option value="1" <?php if($curso['0']->form_inscricao == 1){ echo "selected" ;} ?>>Mostrar</option>
                            <option value="0" <?php if($curso['0']->form_inscricao == 0){ echo "selected" ;} ?>>Esconder</option>
                        </select>
                    </div><br/>
                   ...
                   <div class="input-prepend">
                        ...
                        <textarea name="detalhes" rows="6"><?php echo $curso['0']->detalhes?></textarea>
                   </div>
                   ...
                   <div class="input-prepend">
                        ...
                        <textarea style="width: 700px;" name="pagamento" rows="8"><?php echo $curso['0']->pagamento?></textarea>
                   </div><br/>
