  ...
  <head>
    ...
    <script language="Javascript"> 
        function confirmacao(id) { 
            ...
            if (resposta == true) { 
                window.location.href = "<?=base_url()?>noticias/excluir/"+id; 
            } 
        } 
    </script>
  </head>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <?php if(!empty($busca)){ echo '<a class="btn" type="button" href="'.base_url().'noticias">Voltar</a>'; } ?>    
                ...
                <div class="span4" style="margin: 0px;">
                     <form method="POST" action="<?php echo base_url()?>noticias/buscar">
