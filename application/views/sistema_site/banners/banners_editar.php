                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>banners/editar">
                    ...
                    <div class="input-prepend">
                        ...
                        <select name="target" class="span3" style="width: auto;">
                            <option></option>
                            <option value="_self" <?php if($banner['0']->target == '_self'){ echo "selected"; } ?> >Mesma Janela</option>
                            <option value="_blank" <?php if($banner['0']->target == '_blank'){ echo "selected"; } ?>>Nova Janela</option>
                        </select>
