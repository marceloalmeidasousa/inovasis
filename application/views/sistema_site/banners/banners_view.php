  ...
  <head>
    ...
    <script language="Javascript"> 
        function confirmacao(id) { 
            ...
            if (resposta == true) { 
                window.location.href = "<?=base_url()?>banners/excluir/"+id; 
            } 
        } 
    </script>
  </head>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <?php if(!empty($busca)){ echo '<a class="btn" type="button" href="'.base_url().'banners">Voltar</a>'; } ?>    
                ...
                <div class="span4" style="margin: 0px;">
                     <form method="POST" action="<?php echo base_url()?>banners/buscar">
                    ...
                    <?php 
                        ...
                        foreach ($banners as $val){ ?>
                          <tr <?php if($val->status == 0){ echo ' class="error"';}?>>
                            ...
                            <td>
                                <a href="<?php echo base_url()?>banners/editar/<?php echo $val->id?>"><i title="Editar" class="icon-pencil"></i></a>
                                <?php if($val->status == 1){?>
                                    <a href="<?php echo base_url()?>banners/desativar/<?php echo $val->id?>"><i title="Desativar" class="icon-ok"></i></a>
                                <?php }else{?>
                                    <a href="<?php echo base_url()?>banners/ativar/<?php echo $val->id?>"><i title="Ativar" class="icon-ban-circle"></i></a>
                                <?php }?>
