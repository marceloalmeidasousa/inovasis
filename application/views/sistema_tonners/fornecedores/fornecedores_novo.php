      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>fornecedores/novo">
                    ...
                    <div class="input-prepend">
                        ...
                        <input id="telefone" name="telefone" class="input-block-level" type="text" value="<?php echo set_value('telefone')?>">
                    </div><br/>
                    <div class="input-prepend">
                        <span class="add-on" style="width: 100px; height: 20px; text-align: right; font-weight: bold;">Endereço</span>
                        <input name="endereco" class="input-block-level" type="text" value="<?php echo set_value('endereco')?>">
                    </div><br/>
                    <div class="input-prepend">
