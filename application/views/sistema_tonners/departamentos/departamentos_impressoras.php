      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <?php if(!empty($busca)){ echo '<a class="btn" type="button" href="'.base_url().'departamentos/impressoras">Voltar</a>'; } ?>    
                    ...
                    <?php 
                        ...
                        foreach ($departamentos as $val){ ?>
                          <tr <?php if($val->status == 0){ echo ' class="error"';}?>>
                            ...
                            <td><a href="<?=base_url()?>departamentos/config/<?=$val->id?>"><?php echo $val->nome?></a></td>
