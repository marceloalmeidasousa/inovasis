      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>impressoras/novo">
                    ...
                    <div class="input-prepend">
                        ...
                        <input name="modelo" class="input-block-level" type="text" value="<?php echo set_value('modelo')?>">
                    </div><br/>
                    <div class="input-prepend">
