                ...
                <table class="table table-bordered" style="font-size: 12px;">
                    ...
                    <?php 
                        ...
                        foreach ($impressoras as $val){ ?>
                            ...
                            <td><a href="<?=base_url()?>impressoras/config/<?php echo $val->id?>"><?php echo $val->nome?></a></td>
                            <td><?php echo $val->modelo?></td>
                            <td><?php if($val->status == 1) echo "Ativo"; else echo "Inativo"; ?></td>
                            <td>
                                    <a href="<?=base_url()?>impressoras/config/<?php echo $val->id?>" title="Configurar" class="icon-wrench"></a>
