                ...
                <?php } 
                        ...
                        if($result == true){
                            ...
                            echo "<div class=\"alert alert-success\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>
                                    Vínculo editado com sucesso.
                                  </div>";
                        }
                        
                ?>
                
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>vinculos/editar">
                    <a href="<?php echo base_url()?>vinculos"><button class="btn" type="button">Sair</button></a>
                    <input type="submit" class="btn btn-primary" value="Salvar">
                    <br><br>

                    <input type="hidden" name="id" value="<?=$vinculo['0']->id?>">
                        ...
                        <select name="usuario" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($usuarios as $val){ ?>
                                    ...
                                    <option <?php if($val->id == $vinculo['0']->usuario){echo "selected"; }?> <?php echo set_select('usuario', $val->id); ?> value="<?php echo $val->id?>"><?php echo $val->nome?></option>
                        <?php }
                            ?>
                        </select>
                    </div><br>
                        ...
                        <select name="polo" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($polos as $val){ ?>
                                    ...
                                    <option <?php if($val->id == $vinculo['0']->polo){echo "selected"; }?> <?php echo set_select('polo', $val->id); ?> value="<?php echo $val->id?>"><?php echo $val->nome?></option>
                        <?php }
                            ?>
                        </select>
                    </div><br>
                        ...
                        <select name="curso" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($cursos as $val){ ?>
                                    ...
                                    <option <?php if($val->id == $vinculo['0']->curso){echo "selected"; }?> <?php echo set_select('curso', $val->id); ?> value="<?php echo $val->id?>"><?php echo $val->nome?></option>
                        <?php }
                            ?>
                        </select>
                    </div><br>
                        ...
                        <select name="disciplina" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($disciplinas as $val){ ?>
                                    ...
                                    <option <?php if($val->id == $vinculo['0']->disciplina){echo "selected"; }?> <?php echo set_select('disciplina', $val->id); ?> value="<?php echo $val->id?>"><?php echo $val->nome?></option>
                        <?php }
                            ?>
                        </select>
                    </div><br>
                        ...
                        <select name="tipo" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($tipos as $val){ ?>
                                    ...
                                    <option <?php if($val->id == $vinculo['0']->tipo){echo "selected"; }?> <?php echo set_select('tipo', $val->id); ?> value="<?php echo $val->id?>"><?php echo $val->nome?></option>
                        <?php }
                            ?>
                        </select>
                    </div><br>
                    ...
                    <div class="input-prepend">
                        ...
                        <select name="status" class="span3" style="width: auto;">
                            <option></option>
                            <option value="1" <?php if($vinculo['0']->status == '1'){echo "selected"; }?> <?php echo set_select('status', '1'); ?>>Ativo</option>
                            <option value="0" <?php if($vinculo['0']->status == '0'){echo "selected"; }?> <?php echo set_select('status', '0'); ?>>Desativado</option>
                        </select>
                    </div>
                </form>
