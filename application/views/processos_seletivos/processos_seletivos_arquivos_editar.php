        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
               ...
               <?php if (form_error('nome') || form_error('arquivo') || form_error('status')){?>
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>processos_seletivos/arquivos_editar/<?php echo $processo['0']->id?>">
                    ...
                    <input type="hidden" name="idarquivo" value="<?php echo $arquivo['0']->id?>">
                    <br><br>
                    <div class="input-prepend">
                        <span class="add-on" style="width: 100px; height: 20px; text-align: right; font-weight: bold;">Nome</span>
                        <input name="nome" class="input-block-level" type="text" value="<?php echo $arquivo['0']->nome?>">
                    </div><br/>
                    ...
                    <div class="input-prepend">
                        ...
                        <select name="status" class="span3" style="width: auto;">
                            <option></option>
                            <option value="1" <?php if($arquivo['0']->status == 1){ echo "selected"; } ?>>Ativo</option>
                            <option value="0" <?php if($arquivo['0']->status == 0){ echo "selected"; }  ?>>Desativado</option>
                        </select>
                    </div>
                </form>
          </div>
