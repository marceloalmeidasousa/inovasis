        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <ul class="nav nav-tabs">
                    ...
                    <li>
                        <a href="<?php echo base_url()?>contatos/tipos">Tipos</a>
                    </li>
                    <li>
                ...
                <?php if (form_error('nome') || form_error('status') || form_error('tipo')){?>
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>contatos/editar/<?php echo $contato['0']->id?>">
                    <a href="<?php echo base_url()?>contatos"><button class="btn" type="button">Sair</button></a>
                    ...
                    <div class="input-prepend">
                        ...
                        <input name="nome" class="input-block-level" type="text" value="<?php echo $contato['0']->nome?>">
                    </div><br/>
                    
                    <div class="input-prepend">
                        <span class="add-on" style="width: 100px; height: 20px; text-align: right; font-weight: bold;">Telefone</span>
                        <input name="telefone" class="input-block-level" type="text" value="<?php echo $contato['0']->telefone?>">
                    </div><br/>

                    <div class="input-prepend">
                        <span class="add-on" style="width: 100px; height: 20px; text-align: right; font-weight: bold;">E-mail</span>
                        <input name="email" class="input-block-level" type="text" value="<?php echo $contato['0']->email?>">
                    </div><br/>
                        ...
                        <select name="tipo" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($tipos as $val){ ?>
                                    ...
                                    <option <?php if($val->id == $contato['0']->idtipo){ echo "selected"; }?> value="<?php echo $val->id; ?>"><?php echo $val->nome ?></option>
                    <?php    }
                            ?>
                        </select>
                    </div>
