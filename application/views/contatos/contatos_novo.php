      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>contatos/novo">
                    ...
                    <div class="input-prepend">
                        ...
                        <input name="telefone" class="input-block-level" type="text" value="<?php echo set_value('telefone')?>">
                    </div><br/>
