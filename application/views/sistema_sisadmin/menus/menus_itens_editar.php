                ...
                <?php } 
                    ...
                    if($msg == "true"){ 
                        ...
                        echo '<div class="alert alert-success">
                                <button type="button" class="close" data-dismiss="alert">×</button>
                                Item do Menu editado com sucesso!
                             </div>';
                        
                    }
                ?>
                <form method="POST" action="<?php echo base_url()?>menus/editar_item/<?=$item['0']->id?>">
                    ...
                    <div class="input-prepend">
                        ...
                        <input name="nome" class="input-block-level" type="text" value="<?php echo $item[0]->nome?>">
                    </div><br/>
                        ...
                        <select name="id_menu" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($menus as $val){ ?>
                                    ...
                                    <option value="<?=$val->id?>" <?php if($val->id == $item[0]->id_menu) echo "selected"; ?> ><?=$val->nome?></option>
                        ...
                        <select name="id_metodo" class="span3" style="width: auto;">
                            ...
                            <?php 
                                ...
                                foreach($metodos as $val){ ?>
                                        ...
                                        <option value="<?=$val->id?>" <?php if($val->id == $item[0]->id_metodo) echo "selected"; ?> ><?=$val->apelido?></option>
                              <?php  }
                            ?>
                        </select>
                    </div><br/>
                    <div class="input-prepend">
                        ...
                        <select name="status" class="span3" style="width: auto;">
                            <option></option>
                            <option value="1" <?php if(set_select('status', '1')) echo set_select('status', '1'); else if($item['0']->status == 1) echo "selected"; ?>>Ativo</option>
                            <option value="0" <?php if(set_select('status', '0')) echo set_select('status', '0'); else if($item['0']->status == 0) echo "selected"; ?>>Desativado</option>
                        </select>
                    </div><br/>
                 </form>
          </div>
