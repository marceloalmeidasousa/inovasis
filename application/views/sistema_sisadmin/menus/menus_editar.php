      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                ?>
                <form method="POST" action="<?php echo base_url()?>menus/editar/<?=$menu[0]->id?>">
                    <a href="<?php echo base_url()?>menus"><button class="btn" type="button">Voltar</button></a>
                    ...
                    <div class="input-prepend">
                        ...
                        <input name="nome" class="input-block-level" type="text" value="<?php if(set_value('nome')) echo set_value('nome'); else echo $menu[0]->nome;?>">
                    </div><br/>
                    <div class="input-prepend">
                        ...
                        <select name="status" class="span3" style="width: auto;">
                            <option></option>
                            <option value="1" <?php if(set_select('status', '1')) echo set_select('status', '1'); else if($menu[0]->status == 1)echo "selected";?> >Ativo</option>
                            <option value="0" <?php if(set_select('status', '0')) echo set_select('status', '0'); else if($menu[0]->status == 0)echo "selected";?> >Desativado</option>
                        </select>
                    </div><br/>
                 </form>
          </div>
