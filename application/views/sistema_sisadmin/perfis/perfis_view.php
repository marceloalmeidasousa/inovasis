    ...
    <style type="text/css">
     ...
     <script language="Javascript"> 
        function confirmacao(id) { 
            ...
            if (resposta == true) { 
                window.location.href = "<?=base_url()?>perfis/excluir/"+id; 
            } 
        } 
    </script>
  </head>
      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <a href="<?php echo base_url()?>perfis/novo"><button class="btn btn-primary" type="button">Novo</button></a>
                ...
                <div class="span4" style="margin: 0px;">
                     <form method="POST" action="<?php echo base_url()?>perfis/buscar">
                    ...
                    <?php 
                        ...
                        foreach ($perfis as $val){ ?>
                          <tr <?php if($val->status == 0){ echo ' class="error"';}?>>
                            ...
                            <td>
                                <a href="<?php echo base_url()?>perfis/editar/<?php echo $val->id?>"><i title="Editar" class="icon-pencil"></i></a>
                                <?php if($val->status == 1){?>
                                    <a href="<?php echo base_url()?>perfis/desativar/<?php echo $val->id?>"><i title="Desativar" class="icon-ok"></i></a>
                                <?php }else{?>
                                    <a href="<?php echo base_url()?>perfis/ativar/<?php echo $val->id?>"><i title="Ativar" class="icon-ban-circle"></i></a>
                                <?php }?>
                                  <a href="javascript:func()" onclick="confirmacao('<?=$val->id?>')" title="Excluir" class="icon-trash"></a>
                                  <a href="<?php echo base_url()?>perfis/configurar/<?php echo $val->id?>" title="Configurar" class="icon-wrench"></a>
