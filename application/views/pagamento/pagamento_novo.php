      ...
      <div class="row-fluid">
        ...
        <div class="span9">
          <div class="" style="margin-top: -35px;">
                ...
                <form method="POST" enctype="multipart/form-data" action="<?php echo base_url()?>pagamento/novo">
                    ...
                    <div class="input-prepend">
                        ...
                        <input name="data_abertura" class="input-block-level" type="text" value="<?php echo set_value('data_abertura')?>">
                    </div><br/>
                    <div class="input-prepend">
                        <span class="add-on" style="width: 100px; height: 20px; text-align: right; font-weight: bold;">Fechamento</span>
                        <input name="data_fechamento" class="input-block-level" type="text" value="<?php echo set_value('data_fechamento')?>">
                    </div><br/>
                    <div class="input-prepend">
