                ...
                <form method="POST" action="<?php echo base_url()?>polos/editar">
                        ...
                        <select name="tipo" class="span3" style="width: auto;">
                            ...
                            <?php
                                ...
                                foreach($tipos as $val){ ?>
                                    ...
                                    <option <?php if($val->id == $polo['0']->tipo) echo "selected";?> value="<?=$val->id?>"><?=$val->nome?></option>
                         <?php    }
                            ?>
                        </select>
                    </div><br/>
                    <div class="input-prepend">
                        ...
                        <select name="status" class="span3" style="width: auto;">
                            <option></option>
                            <option value="1" <?php if($polo['0']->status == 1) echo "selected"; ?>>Ativo</option>
                            <option value="0" <?php if($polo['0']->status == 0) echo "selected";  ?>>Desativado</option>
                        </select>
                    </div>
                </form>
          </div>
