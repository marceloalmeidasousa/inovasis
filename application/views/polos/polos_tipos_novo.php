                ...
                <?php } 
                        ...
                        if($result == true){
                            ...
                            echo "<div class=\"alert alert-success\">
                                    <button type=\"button\" class=\"close\" data-dismiss=\"alert\">×</button>
                                    Tipo de polo cadastrado com sucesso.
                                  </div>";
                        }
                        
                ?>
                
                <form method="POST" action="<?php echo base_url()?>polos/novo_tipo">
                    <a href="<?php echo base_url()?>polos/tipos"><button class="btn" type="button">Sair</button></a>
